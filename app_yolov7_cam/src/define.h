...
* File Name    : define.h
* Version      : 2.5.0
* Description  : RZ/V2H DRP-AI Sample Application for WongKinYu YOLOV7 with MIPI/USB Camera
***********************************************************************************************************************/
...
#if(1)  // TVM
/* Model Binary */
const static std::string model_dir = "yolov7_cam";
