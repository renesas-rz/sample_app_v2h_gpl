...
#if(1)  // TVM
/* Model Binary */
const static std::string model_dir = "yolov6_cam";
...
/* Number of DFL channel (default:1) */
#define REG_MAX                     (1)
...
const static uint32_t num_inf_out =  num_class80_out + num_dfl80_out
                                + num_class40_out + num_dfl40_out
                                + num_class20_out + num_dfl20_out;
