...
* File Name    : define.h
* Version      : 2.5.0
* Description  : RZ/V2H DRP-AI Sample Application for Ultralytics YOLOV5 with MIPI/USB Camera
***********************************************************************************************************************/
